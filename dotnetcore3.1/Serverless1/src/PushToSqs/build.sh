#!/bin/bash
dotnet publish ./PushToSqs.csproj --configuration "Release" --framework "netcoreapp3.1" /p:PublishReadyToRun=true /p:GenerateRuntimeConfigurationFiles=true --runtime linux-x64 --self-contained false
